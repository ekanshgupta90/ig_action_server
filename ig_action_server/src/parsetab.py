...
_lr_productions = [
  ...
  ('program -> P LPAR vertex COMMA vertices RPAR','program',6,'p_program','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',53),
  ('vertices -> NIL','vertices',1,'p_vertices','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',57),
  ('vertices -> vertex CONS vertices','vertices',3,'p_vertices','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',58),
  ('vertex -> V LPAR NUM COMMA content RPAR','vertex',6,'p_vertex','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',65),
  ('content -> DO action THEN NUM','content',4,'p_content','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',71),
  ('content -> DO action UNTIL cnd THEN NUM','content',6,'p_content','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',72),
  ('content -> IF cnd THEN NUM ELSE NUM','content',6,'p_content','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',73),
  ('content -> GOTO NUM','content',2,'p_content','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',74),
  ('content -> END','content',1,'p_content','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',75),
  ('action -> MOVE LPAR NUM COMMA NUM COMMA NUM COMMA NUM COMMA NUM RPAR','action',12,'p_action','/home/ej/catkin_ws/src/ig_action_server/src/parserIG.py',98),
